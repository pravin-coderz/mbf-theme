...
if(isset($_REQUEST['export']) && $_REQUEST['export'] == 'report_list'):
    ...
    // Read from Database.
    $query = "SELECT * FROM VzQCxSJv7_report ORDER BY `posted_date` desc";
...
class List_Table extends WP_List_Table {
    ...
    function prepare_items() {
       ...
       $query = "SELECT * FROM ". $wpdb->prefix ."report";
 ...
 function display_rows()
    { ?> <br /><br /><span style="float:right; margin-bottom: 29px; margin-top: 9px;"><a href="?page=<?php echo $_REQUEST['page']?>&export=report_list" id="export-report_list" class="button" >Export</a></span>
       <?php
        $records = $this->items;
...
function add_menu_items() {
    add_menu_page('Report List Table', 'Report List', 'activate_plugins', 'tt_report_test', 'render_list_page');
}
...
function render_list_page() {
    ...
    <div class="wrap">
        ...
        <div id="icon-userss" class="icon32"><br/></div>
